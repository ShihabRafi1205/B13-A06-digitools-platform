    ...
    <div className="grid grid-cols-3 gap-6 mt-12  mx-auto  w-[80%] items-stretch">
        ...
        <div className="space-y-4">
          ...
          <ul className="mt-6 flex flex-col gap-2 text-xs">
            ...
            <li>
              ...
              <span>A1 project per month</span>
            </li>
          </ul>
        </div>
          <div className="mt-auto">
            <button className="btn text-white btn-block rounded-full bg-linear-to-r from-blue-500 to-purple-500 ">Subscribe</button>
          </div>
        </div>
      </div>
      ...
      <div className="card relative bg-base-100 shadow-sm bg-linear-to-r from-blue-500 to-purple-500 text-white">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-6">
            <button className="btn  btn-block rounded-full "><span className="bg-linear-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Start Pro Trial</span></button>
          </div>
        </div>
      </div>
